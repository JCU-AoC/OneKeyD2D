...
namespace Vector {
    ...
    public:
        ...
        Vector3(const DataType& val)
            : x(val)
            , y(val)
            , z(val)
        {
        }
        Vector3(const DataType& xx, const DataType& yy, const DataType& zz)
            : x(xx)
            , y(yy)
            , z(zz)
        {
    ...
    public:
        ...
        Vector2(const DataType& val)
            : x(val)
            , y(val)
        {
        }
        Vector2(const DataType& xx, const DataType& yy)
            : x(xx)
            , y(yy)
        {
        }
    ...
    public:
        ...
        Vector4(const DataType& xx, const DataType& yy, const DataType& zz, const DataType& ww)
            : x(xx)
            , y(yy)
            , z(zz)
            , w(ww)
...
namespace Random {
    ...
    public:
        PerlinNoise1()
            ...
            , m_max(0)
            , m_count(0)
            , m_InF(Interpolation::Smoothstep)
        {
        }
    ...
    public:
        ...
        PerlinNoise2(int randomSeed, const Vector::Vec2i& minR, const Vector::Vec2i& maxR, const Vector::Vec2i& randomConut)
            : m_min(minR)
            , m_max(maxR)
        {
            Init(randomSeed, randomConut, minR, maxR);
